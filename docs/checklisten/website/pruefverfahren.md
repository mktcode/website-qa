...
Der strukturierte Nachweispilot liefert atomare Aussagen zu Main-Landmark, horizontalem Überlauf in den technischen 320-Pixel- und 200-%-Näherungsprofilen, Axe-Befunden, dokumentiertem Chromium-/Headless-Kontext sowie beobachteten Konsolen-, JavaScript-, Netzwerk- und HTTP-Fehlern. Fehlende Profile, Seitenlimits, Laufzeitfehler oder sicherheitsbedingt blockierte Seitenrequests führen bei abhängigen Aussagen zu `inconclusive`. Semantische Angemessenheit, tatsächliche reine Textvergrößerung, Tastatur, Screenreader, reale Mobilbrowser und interaktionsabhängige Zustände bleiben getrennte manuelle Kriterien. Auch ein vollständig grüner Axe-Lauf ist kein WCAG-Konformitätsnachweis.

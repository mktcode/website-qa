...
Der Standardlauf verwendet isolierte, nicht persistente Browserkontexte für Desktop, 390 und 320 CSS-Pixel, Reduced Motion und eine ausdrücklich als Näherung bezeichnete 200-%-Zoom-Prüfung. Er inventarisiert Browserkonsole, JavaScript-/Netzwerkfehler, Overflow, Cookies, Local-/Session-Storage, IndexedDB, Grundstruktur und axe-core-Befunde. Das Werkzeug klickt nie und blockiert Formularübermittlungen bereits im DOM sowie auf Netzwerkebene. Alle Nicht-GET-Anfragen, externen Seitenrequests, Popups, Beacons, Worker, WebSockets, WebTransport und WebRTC werden blockiert und protokolliert. Diese Grenzen dürfen ohne ein gesondertes Prüfverfahren nicht gelockert werden.

...
- `website-pilot.json` enthält ausgewählte HTTP-, Crawl- und Browser-nahe Punkte sowie mit `CORE-DOM-04` und `GOV-RGT-02` bewusst rein administrative, externe und kommunikative Nachweise.
